...
Examples:
  bn-audit-prep-functions-bn --bv-match target --root kaudit UsbDev_AllocURB Checkpoint_Restore_3
  bn-audit-prep-functions-bn --bv-match target --addr 0xb07ef0 --addr 0x699ea0
"""
import argparse
import json
import os
