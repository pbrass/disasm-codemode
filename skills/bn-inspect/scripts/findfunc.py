...
"""findfunc.py - locate functions / resolve symbols (BN "where is ..." task).
  ...
  findfunc.py --file /tmp/target parse             # functions whose name contains 'parse'
  findfunc.py --file /tmp/target --regex '^Handle.*Request'
  findfunc.py --file /tmp/target --addr 0x401000   # what function/symbol is at this address
