...
"""scansec.py - inspect sections / read bytes / scan data (stripped-daemon data recipe).
  ...
  scansec.py --file /tmp/target                              # list sections
  scansec.py --file /tmp/target --read 0x4af39a --len 64     # hexdump bytes at an address
  scansec.py --file /tmp/target --section .data --ptrs       # code-pointer arrays (EPV/ifspec hunt)
  scansec.py --file /tmp/target --section .rodata --strings --minstr 6
