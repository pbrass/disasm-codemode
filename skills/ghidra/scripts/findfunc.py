...
"""gh-find — locate functions / resolve symbols ("where is ..." task).
  ...
  gh-find --file /tmp/target parse             # functions whose name contains 'parse'
  gh-find --file /tmp/target --regex '^Handle.*Request'
  gh-find --file /tmp/target --addr 0x102240   # what function/symbol is at this address
  gh-find --file /tmp/target memcpy --no-imports
