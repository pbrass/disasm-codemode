...
"""gh-scansec — inspect memory blocks / read bytes / scan data.
  ...
  gh-scansec --file /tmp/target                              # list blocks (sections)
  gh-scansec --file /tmp/target --read 0x102004 --len 64     # hexdump bytes at an address
  gh-scansec --file /tmp/target --section .data --ptrs       # code-pointer arrays
  gh-scansec --file /tmp/target --section .rodata --strings --minstr 6
