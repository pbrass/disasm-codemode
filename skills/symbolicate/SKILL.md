...
```
bn-sym-review-protos target.sidecar.json --bv-match target \
...
```
bn-sym-slice-protos target.sidecar.json proto_review/proto_review.clean_parse.json \
  ...
  --limit 50 --offset 0
bn-re-apply proto_review/proto_slices/boring_safe.001.sidecar.json --bv-match target --no-vars
```
